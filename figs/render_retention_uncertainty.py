...
# Load the data files
base_psnrs = np.load('activebase_ret_uncertainty_psnrs.npy')[::-1]
active_psnrs = np.load('active_ret_uncertainty_psnrs.npy')[::-1]
...
plt.savefig("rentetion_uncertainty_psnrs.png")